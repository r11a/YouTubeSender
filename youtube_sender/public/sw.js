const CACHE = "youtube-sender-v6";
const SHELL = ["./", "./styles.css?v=0.2.3", "./theme-granite.css?v=0.2.3", "./app.js?v=0.2.3", "./icon-192.png?v=0.2.3", "./manifest.webmanifest?v=0.2.3"];
