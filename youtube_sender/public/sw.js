const CACHE = "youtube-sender-v7";
const SHELL = ["./", "./styles.css?v=0.3.0", "./theme-granite.css?v=0.3.0", "./app.js?v=0.3.0", "./icon-192.png?v=0.3.0", "./manifest.webmanifest?v=0.3.0"];
