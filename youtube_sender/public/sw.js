const CACHE = "youtube-sender-v10";
const SHELL = ["./", "./styles.css?v=0.5.0", "./theme-granite.css?v=0.5.0", "./app.js?v=0.5.0", "./icon-192.png?v=0.5.0", "./manifest.webmanifest?v=0.5.0"];
