const CACHE = "youtube-sender-v4";
const SHELL = ["./", "./styles.css?v=0.2.1", "./theme-granite.css?v=0.2.1", "./app.js?v=0.2.1", "./icon-192.png?v=0.2.1", "./manifest.webmanifest?v=0.2.1"];
